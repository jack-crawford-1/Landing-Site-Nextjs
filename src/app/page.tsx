...
function Home() {
  return (
    <main
      className={` overflow-x-hidden flex flex-col items-center justify-center md:p-10 p-3 bg-[#070706] text-white md:bg-fixed  md:bg-cover md:bg-center md:bg-[url(/bg-1.jpg)] bg-black`}
    >
