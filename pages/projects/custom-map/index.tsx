      ...
      .then(() => {
        if (mapRef.current && window.google && window.google.maps) {
          ...
          <p className="max-w-[800px]">
            ...
            huts and tracks country-wide, and LINZ had similar information but
            focused on walking and biking tracks as well as having the much
            needed topographical overlay. Because it&apos;s not a hiking app if
            it&apos;s not in topo, right?
          </p>
          ...
          <p className="max-w-[800px]">
            ...
            level and coordinates as an image. It can be a bit janky at time
            when zooming too quick which I&apos;d like to look at fixing with
            some kind of caching or preloading of tiles.
          </p>
          <div className="max-w-[800px] pt-5 pb-5">
            <div
              className="p-5 rounded-lg overflow-auto"
          ...
          <p className="max-w-[800px] pb-3">
            ...
            wasn&apos;t ideal but I figured I would filter out the tracks later
            on and look at another way to display them, but this would be a good
          ...
          <p className="max-w-[800px]">
            ...
            markers showing. I discovered that the data provided by LINZ was in
            NZTM2000 format, which is a common projection used in New Zealand,
            but Google Maps requires WGS84 coordinates.
          </p>
          <div className="max-w-[800px] pt-5 pb-5">
            <div
              className="p-5 rounded-lg overflow-auto"
  ...
  if (!proj4.defs[sourceProj]){' '}
    ...
    +x_0=1600000 +y_0=10000000 +datum=WGS84 +units=m +no_defs'
          ...
          <p className="max-w-[800px]">
            ...
            the coordinates from NZTM2000 to WGS84 and then once the coordinates
            were in a useable format, I was able to fetch the geoJSON from my
            server, then loop through the features and created a marker for each
            one.
          </p>
    ...
    data.features.forEach((feature) => {
      if (feature.geometry.type === 'Point') {
        ...
        lat,
          ...
          />
          <p className="max-w-[800px] pb-4">
            I wanted to use the newer, Advanced Marker elements from Google but
            I wasn&apos;t able to get the custom SVG to work quickly so
            I&apos;ve left as is for now. I&apos;m conscious the old Markers
            class has been deprecated so I&apos;ll need to look at updating this
            in the future. I also added a click event to the marker to show the
            name of the feature when clicked which shows up as an alert. I could
            have used a custom overlay to show the name in a more user friendly
            way but this was just a quick test and I&apos;ll likely return to it
            at some point when migrating the markers.
          </p>
          <div className="max-w-[800px] pt-5 pb-5">
            <div
              className="p-5 rounded-lg overflow-auto"
...
marker.addListener('click', () => {alert(feature.properties.name)`}
          ...
          <p className="max-w-[800px] pb-5">
            ...
            focus on interactivity. Being able to plan and map your own routes,
            save offline, and share with others along with waypoints and
            real-time updates, community contributions, and feedback would all
            be great inclusions.
          </p>
          <Image
          ...
          <p className="max-w-[800px] pb-3">
            ...
            to plot into a line, improving on the single point received from the
            geoJSON file so this would be a likely next step.
          </p>
          <Image
